...
public class RobustWebDriver implements WebDriver {
    private final ChromeDriver originalWebDriver;

    public RobustWebDriver(ChromeDriver webDriver) {
    ...
    public List<WebElement> findElements(By by) {
        return this.originalWebDriver.findElements(by)
                .stream().map(e -> new RobustWebElement(e, this, by))
                .collect(Collectors.toList());
    }

    @Override
    public WebElement findElement(By by) {
        return new RobustWebElement(this.originalWebDriver.findElement(by), this, by);
    }
